    ...
    <section className="about__container">
      ...
      <div className="about__information-container">
        ...
        <p className="about__description">
          ...
          I&apos;m currently a Ride Tech at a theme park, but I&apos;m aspiring
          to be a Software Engineer some day. I have learned and now know a ton
          of development technologies like HTML, CSS, JavaScript, React,
          Node.js, Express.js, and many more. Checkout my GitHub with the link
          down below to see some of my other projects.
          <br />
          ...
          get through the material. If you&apos;re interested you can check out
          their site in the link below to view all that they offer.
        </p>
      </div>
    </section>
  );
